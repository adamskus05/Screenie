        ...
        if os.path.exists(SCHEMA_FILE):
            with sqlite3.connect(DB_FILE) as conn:
                ...
                try:
                    ...
                    app.logger.info("Set restrictive permissions on database file")
                except Exception as e:
                    app.logger.warning(f"Failed to set database file permissions: {e}")
        else:
...
if __name__ == '__main__':
    ...
    if ENVIRONMENT == 'production':
        ...
        # Development mode - run without SSL
